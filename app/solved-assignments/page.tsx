...
export default function SolvedAssignmentsPage() {
  ...
  // DEFAULT SELECTED: "Solved Assignments" (Exact Name from Navbar)
  const [selectedCat, setSelectedCat] = useState<string[]>(["Solved Assignments"]);
    ...
    <main className="min-h-screen font-sans bg-white text-slate-800">
      ...
      <div className="h-[45px] bg-gray-50 border-b border-gray-200 flex items-center">
         <div className="max-w-[1600px] mx-auto px-4 w-full text-[14px] text-gray-500 whitespace-nowrap overflow-hidden text-ellipsis">
            ...
            <Link href="/solved-assignments" className="hover:text-blue-600 mx-1">Solved Assignment</Link> / 
      ...
      <section className="bg-white py-10 border-b border-gray-100">
         <div className="max-w-[1600px] mx-auto px-4">
             <h1 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">{breadcrumbText}</h1>
         ...
         <div className="max-w-[1600px] mx-auto px-4">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start relative">
               ...
               <div className="flex-1 w-full min-w-0">
                  ...
                  <SortBar />
                  {/* PASS SELECTED CAT to Product Grid */}
         ...
         <div className="max-w-[1600px] mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 gap-8 text-gray-600 text-base leading-relaxed">
               <ul className="space-y-3">
                  <li className="flex gap-3"><Check size={20} className="text-green-500 mt-1"/> 100% Correct Answers</li>
                  <li className="flex gap-3"><Check size={20} className="text-green-500 mt-1"/> Instant PDF Download</li>
               </ul>
            </div>
         </div>
      </section>
