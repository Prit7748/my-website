    ...
    <main className="min-h-screen font-sans text-slate-800 bg-white">
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="max-w-[1600px] mx-auto px-4 py-3 text-[13px] text-gray-500 flex items-center gap-2 overflow-x-auto whitespace-nowrap">
          ...
          {/* Correction: Removed the duplicate Link to /solved-assignments here so it shows "Home > Solved Assignments" */}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-[1600px] mx-auto px-4 py-7 md:py-12">
          <div className="flex flex-col lg:flex-row lg:items-center gap-6 lg:gap-10">
            <div className="flex-1 min-w-0">
              <div className="inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-[11px] font-extrabold text-blue-700">
                <Sparkles size={14} /> Verified & Updated for your session
              </div>
              ...
              <p className="mt-2 text-sm md:text-lg font-medium text-slate-600 max-w-3xl">
                Select course & session to find the exact assignment. This page is dedicated to Solved Assignments only.
              </p>
              ...
              <div className="rounded-2xl border border-gray-200 bg-white shadow-sm overflow-hidden">
                <div className="p-4 bg-gradient-to-r from-blue-700 via-indigo-700 to-cyan-600 isp-shimmer text-white">
                  ...
                  <div className="mt-1 text-xs font-bold opacity-90">
                    Filters use real DB data. Category + Course + Session narrows results.
                  </div>
                </div>
                <div className="p-5">
                  <div className="text-xs font-extrabold text-slate-900">Best way to find your assignment</div>
          ...
          {/* ✅ SEO ribbon: DESKTOP ONLY (mobile pe completely hide) */}
          <div className="hidden md:block mt-6 rounded-2xl border border-gray-200 bg-white/80 backdrop-blur shadow-sm p-4 md:p-5">
            <div className="text-sm md:text-base font-extrabold text-slate-900">
              Download IGNOU Solved Assignments PDF (Updated Session-wise)
            </div>
            <div className="mt-1 text-xs md:text-sm font-semibold text-slate-600 leading-relaxed">
              Choose your Course & Session to match the exact question paper. If you want multiple categories (like
              Ebooks + Assignments), select them and you’ll be redirected to All Products automatically.
            </div>
            <div className="mt-3">
              <Link
                href="/products"
      ...
      {/* ✅ END CTA moved ABOVE "Why Choose Us?" heading */}
        ...
        <div className="max-w-[1600px] mx-auto px-4">
          <div className="rounded-2xl border border-gray-200 bg-gray-50 p-5 md:p-6 relative overflow-hidden">
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              <div className="min-w-0">
                ...
                <div className="mt-1 text-sm font-semibold text-slate-600">
                  Explore all categories in one place (Ebooks, Projects, PYQ, Combo, etc). You can also combine filters
                  there.
                </div>
              </div>
              ...
              <div className="md:shrink-0">
                <Link
                  href="/products"
                  className="w-full md:w-auto inline-flex items-center justify-center px-5 py-3 rounded-2xl bg-slate-900 text-white font-extrabold hover:bg-slate-800 transition"
                >
                  Go to All Products →
                </Link>
              </div>
            ...
            <div className="mt-4 text-sm font-semibold text-slate-600 leading-relaxed">
              Download solved IGNOU assignments for your course code and session. Use filters to find the exact
              assignment quickly.
            </div>
          </div>
        </div>
      ...
      <section className="bg-white py-10 md:py-12">
        <div className="max-w-[1600px] mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { t: "100% Correct Answers", d: "Well-structured solutions, exam-friendly format." },
