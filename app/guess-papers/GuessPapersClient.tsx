...
const CATEGORY_LABEL = "Guess Papers";
const PAGE_PATH = "/guess-papers";
const PAGE_URL = "https://istudentsportal.com/guess-papers";
...
function buildGuessPapersQueryKey(input: {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-1 text-[12px] font-semibold text-slate-600 md:text-[13px]">
                Find the exact IGNOU guess paper using subject code, course, session, and medium.
              </div>
            </div>
          </div>
...
export default function GuessPapersClient({
  initialSearchParam = "",
  initialCourseParam = "",
  initialSessionParam = "",
  ...
  }, [spKey, initialUrlSearch, initialUrlCourse, initialUrlSession, initialUrlLang, initialUrlPage]);
  ...
  const queryKey = useMemo(() => {
    return buildGuessPapersQueryKey({
  ...
  const resultSummary = useMemo(() => {
    ...
    if (!parts.length) {
      return "Browse IGNOU guess papers across courses, sessions, and mediums.";
    }
  ...
  const studentGuideParagraph = useMemo(() => {
    if (appliedSearch || selectedCourse.length || selectedSession.length || selectedLang.length) {
      return "Use subject code or exact title first whenever possible, then match the course, session, and medium. This makes it easier to reach the most relevant guess paper with fewer wrong clicks.";
    }

    return "Most students search guess papers in a practical way: first by subject code or title, then by course, then by session, and finally by medium. This page follows that same flow so product matching feels clearer and faster.";
  ...
  const faqJsonLd = useMemo(() => {
    const schema = {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How do I find the correct IGNOU guess paper on this page?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Guess paper material is usually chosen for a specific exam cycle, so session matching helps students choose more relevant material.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Subject code is usually more precise, but course code filters are useful when you want to browse all related guess papers inside one programme.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Verify the title, subject code, course, session, and medium. These details help avoid opening the wrong guess paper product.",
          },
        },
      ],
    };
  ...
  const collectionJsonLd = useMemo(() => {
    const schema = {
      "@context": "https://schema.org",
      "@type": "CollectionPage",
      name: "IGNOU Guess Papers",
      url: PAGE_URL,
      description:
        "Browse IGNOU guess papers by subject code, course, session, and medium.",
      isPartOf: {
        "@type": "WebSite",
            ...
            <div className="grid gap-6 px-5 py-6 md:px-7 md:py-7 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.7fr)] lg:items-start">
              <div className="max-w-4xl">
                <div className="inline-flex items-center rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[11px] font-extrabold uppercase tracking-[0.2em] text-blue-100">
                  Exam-focused discovery • faster shortlist
                </div>
                ...
                <p className="mt-3 max-w-3xl text-sm font-medium leading-6 text-blue-50/90 md:text-base">
                  Search guess papers quickly using subject code, course, session, and medium. The top
                  section stays clean and student-focused, while the lower section helps students make a more
                  accurate selection.
                </p>
              ...
              <div className="grid gap-3">
                <div className="rounded-[26px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-blue-50/85">
                    Use codes like BEGC 101, BPSC 134, or your course code to reach the most relevant IGNOU guess paper faster.
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      <BookOpen className="mt-0.5 text-emerald-300" size={18} />
                      <div>
                        <div className="text-sm font-extrabold text-white">Exam-first</div>
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Cleaner discovery flow for revision-oriented material.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Search first, filter next, then open the exact guess paper.
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="rounded-[24px] border border-emerald-300/25 bg-emerald-400/10 p-4 text-sm font-semibold leading-6 text-emerald-50">
                  ...
                  <span className="font-extrabold text-white">medium</span> before opening a guess paper product page.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="mt-1 text-xl font-extrabold text-slate-900 md:text-2xl">
                  Find the right IGNOU guess paper faster
                </h2>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-3">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Codes like BEGC 101, BPSC 134, or MTE 01 usually return the cleanest guess paper result.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Sometimes the wrong session or medium filter blocks otherwise relevant guess paper matches.
                    </p>
                  </div>
          ...
          <section className="mt-10 space-y-6">
              ...
              <div className="grid gap-6 p-5 md:p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:items-start">
                <div>
                  ...
                  <h2 className="mt-4 text-2xl font-extrabold leading-tight text-slate-900 md:text-3xl">
                    How to select the right guess paper with less confusion
                  </h2>
                  ...
                  <p className="mt-3 text-sm font-medium leading-7 text-slate-700 md:text-[15px]">
                    A practical order works best: search the subject code or exact title first, then confirm the course,
                    then match the session, and finally check the medium before opening the product page. This keeps
                    browsing simpler on large catalogues where many names may look similar at first glance.
                  </p>

                  <p className="mt-3 text-sm font-medium leading-7 text-slate-700 md:text-[15px]">
                    Students usually prefer guess paper browsing to feel quick, focused, and exam-oriented. That is why
                    the top section is kept compact for fast filtering, while the lower section explains the checks that
                    matter before choosing a product.
                  </p>
                </div>
                ...
                <div className="grid gap-3">
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex items-start gap-2">
                      <BookOpen className="mt-0.5 text-indigo-600" size={18} />
                      <div>
                        <div className="text-[11px] font-extrabold uppercase tracking-wide text-slate-500">
                          Why this page works better
                        </div>
                        <div className="mt-2 text-base font-extrabold text-slate-900">
                          Cleaner top section, clearer exam-focused selection
                        </div>
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                          Students can browse quickly and still understand what to check before opening any product.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-2 text-base font-extrabold text-slate-900">
                          Subject code + session + medium
                        </div>
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                          That combination usually gives the highest confidence when matching the right IGNOU guess paper.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                <h3 className="text-xl font-extrabold text-slate-900">
                  What to check before opening a guess paper
                </h3>
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Exact codes and titles usually reach the correct result faster than broad keywords.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Course matching matters because similar subject names may appear in different programmes.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">3. Confirm the session</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Session matching helps students pick material for the right exam cycle.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">4. Check the medium</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Medium confirmation is important before moving to the final product page.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                <h3 className="text-xl font-extrabold text-slate-900">
                  Why students use filters before choosing
                </h3>
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">Faster shortlist</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Filters reduce the need to open many unrelated products one by one.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">Less mismatch</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Course, session, and medium checks help avoid selecting the wrong material.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">Exam-focused flow</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Guess paper browsing should feel quick and revision-oriented, not overloaded.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">Clearer decisions</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      A small amount of checking before opening the product saves time later.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <div className="mt-5 divide-y divide-slate-200">
                <details className="group py-4" open>
                  <summary className="cursor-pointer list-none pr-8 text-sm font-extrabold text-slate-900 marker:content-none">
                    How do I find the correct IGNOU guess paper on this page?
                  </summary>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Guess paper material is usually chosen for a specific exam cycle, so session matching
                    helps students choose more relevant material.
                  </p>
                </details>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    ...
                    you want to browse all related guess papers inside one programme.
                  </p>
                </details>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Verify the title, subject code, course, session, and medium. These details help avoid opening the wrong guess paper product.
                  </p>
                </details>
              </div>
            </div>
            ...
            <div className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {[
                  {
                    t: "Exam-focused material",
                    d: "Guess papers organized for faster discovery and revision planning.",
                  },
                  {
                    t: "Fast digital discovery",
