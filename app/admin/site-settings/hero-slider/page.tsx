    ...
    <main className="min-h-screen bg-gray-100 text-slate-900">
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="rounded-3xl bg-white border border-gray-200 p-6 shadow-sm">
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div>
              ...
              <div className="text-sm text-slate-600 mt-1">
                Desktop + Mobile slides (separate sizes), order, active, link
              </div>
            </div>
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2">
                ...
                <div className="text-[11px] text-slate-500 mt-1">
                  Desktop: landscape. Mobile: portrait/square ratio.
                </div>
              </div>
          ...
          <div className="mt-6">
            <div className="font-extrabold text-slate-800">Slides ({device})</div>
          ...
          <div className="mt-6 text-xs text-slate-500">
            Next: Notifications section backend (ticker/alerts).
          </div>
        </div>
      </div>
    </main>
