...
export default async function RefundPolicyPage() {
  const db = await getPolicy("refund-policy");
      ...
      <div className="max-w-[1000px] mx-auto px-4 py-12">
        <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-200">
          <h1 className="text-3xl font-bold text-slate-900 mb-6">
            {useDb ? String(db?.title || "Refund & Cancellation Policy") : "Refund & Cancellation Policy"}
          </h1>

          <p className="text-slate-500 mb-8 text-sm bg-gray-100 inline-block px-3 py-1 rounded-full">
          ...
          {useDb ? (
            ...
            <div className="space-y-8 text-slate-700 leading-relaxed">
              <section className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                ...
                <p className="mb-3">
                  Since our primary products are digital files (Solved Assignments, Notes, Guess Papers) that are
                  downloadable instantly after payment, <strong>we strictly do not offer refunds</strong> once the file
                  has been downloaded or emailed to you.
                </p>
                ...
                <p className="mt-3 text-sm text-slate-600">
                  In such cases, please contact us within 24 hours via WhatsApp or Email, and we will send the correct
                  file immediately or issue a full refund.
                </p>
              </section>
              ...
              <section className="bg-orange-50 p-6 rounded-xl border border-orange-100">
                ...
                <p className="mb-3">For handwritten assignments or notes delivered via courier:</p>
                <ul className="list-disc ml-5 mt-2 space-y-1 text-sm">
                  <li>
                    <strong>Cancellation:</strong> You can cancel your order within 24 hours of placing it, provided it
                    has not been shipped yet. Once shipped, orders cannot be cancelled.
                  </li>
                  <li>
                    <strong>Return/Replacement:</strong> We do not accept returns. However, if you receive a damaged
                    product or missing pages, we will send a replacement free of cost. Please record an unboxing video
                    as proof.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p>
                  If your refund request is approved, the amount will be processed within <strong>5-7 working days</strong>{" "}
                  and credited back to your original payment method (Bank Account, UPI, or Card) via Razorpay.
                </p>
              </section>
