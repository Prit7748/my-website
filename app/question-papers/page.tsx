...
async function getInitialQuestionPapersData(input: {
  course?: string;
  session?: string;
  language?: string;
  search?: string;
...
export default async function Page({ searchParams }: PageProps) {
  ...
  const { products, meta } = await getInitialQuestionPapersData({
  ...
  const initialQueryKey = buildQuestionPapersQueryKey({
    course: initialCourseParam,
    session: initialSessionParam,
    language: initialLanguageParam,
    search: initialSearchParam,
