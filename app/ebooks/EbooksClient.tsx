...
const PAGE_PATH = "/ebooks";
const PAGE_URL = "https://istudentsportal.com/ebooks";
...
function buildEbooksQueryKey(input: {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-1 text-[12px] font-semibold text-slate-600 md:text-[13px]">
                Find the exact IGNOU ebook using subject code, course, session, and medium.
              </div>
            </div>
          </div>
...
export default function EbooksClient({
      ...
      try {
        ...
        if (productsRes.status === "fulfilled") {
          try {
            ...
            facetSessionsRaw = safeArr(data?.facets?.sessions).map((x) => safeStr(x)).filter(Boolean);
  ...
  const resultSummary = useMemo(() => {
    ...
    if (!parts.length) {
      return "Browse IGNOU ebooks across courses, sessions, and mediums.";
    }
  ...
  const studentGuideParagraph = useMemo(() => {
    if (appliedSearch || selectedCourse.length || selectedSession.length || selectedLang.length) {
      return "Use subject code or exact title first whenever possible, then match the course, session, and medium. This makes it easier to reach the most relevant ebook with fewer wrong clicks.";
    }

    return "Most students search ebooks in a practical way: first by subject code or title, then by course, then by session, and finally by medium. This page follows that same flow so product matching feels clearer and faster.";
  ...
  const faqJsonLd = useMemo(() => {
    const schema = {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How do I find the correct IGNOU ebook on this page?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Ebook material is often chosen for a specific academic cycle, so session matching helps students choose more relevant content.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Subject code is usually more precise, but course code filters are useful when you want to browse all related ebooks inside one programme.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Verify the title, subject code, course, session, and medium. These details help avoid opening the wrong ebook product.",
          },
        },
      ],
    };
  ...
  const collectionJsonLd = useMemo(() => {
    const schema = {
      ...
      url: PAGE_URL,
      description:
        "Browse IGNOU ebooks by subject code, course, session, and medium.",
      isPartOf: {
        "@type": "WebSite",
              ...
              <div className="grid gap-3">
                <div className="rounded-[26px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-blue-50/85">
                    Use codes like BEGC 101, BPSC 134, or your course code to reach the most relevant IGNOU ebook faster.
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <div className="text-sm font-extrabold text-white">Study-first</div>
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Cleaner discovery flow for digital study material.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Search first, filter next, then open the exact ebook.
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="rounded-[24px] border border-emerald-300/25 bg-emerald-400/10 p-4 text-sm font-semibold leading-6 text-emerald-50">
                  ...
                  <span className="font-extrabold text-white">medium</span> before opening an ebook product page.
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="mt-1 text-xl font-extrabold text-slate-900 md:text-2xl">
                  Find the right IGNOU ebook faster
                </h2>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-3">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Codes like BEGC 101, BPSC 134, or MTE 01 usually return the cleanest ebook result.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Sometimes the wrong session or medium filter blocks otherwise relevant ebook matches.
                    </p>
                  </div>
          ...
          <section className="mt-10 space-y-6">
              ...
              <div className="grid gap-6 p-5 md:p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:items-start">
                <div>
                  ...
                  <h2 className="mt-4 text-2xl font-extrabold leading-tight text-slate-900 md:text-3xl">
                    How to select the right ebook with less confusion
                  </h2>
                  ...
                  <p className="mt-3 text-sm font-medium leading-7 text-slate-700 md:text-[15px]">
                    Students usually prefer ebook browsing to feel quick, clean, and study-oriented. That is why
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-2 text-base font-extrabold text-slate-900">
                          Cleaner top section, clearer digital study selection
                        </div>
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                  ...
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                          That combination usually gives the highest confidence when matching the right IGNOU ebook.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                <h3 className="text-xl font-extrabold text-slate-900">
                  What to check before opening an ebook
                </h3>
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Session matching helps students pick material for the right academic cycle.
                    </p>
                  </div>
              ...
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                ...
                <div className="mt-4 space-y-4">
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">Better digital browsing</div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Ebook discovery should feel quick, clean, and easy to scan.
                    </p>
                  </div>
              ...
              <div className="mt-5 divide-y divide-slate-200">
                <details className="group py-4" open>
                  <summary className="cursor-pointer list-none pr-8 text-sm font-extrabold text-slate-900 marker:content-none">
                    How do I find the correct IGNOU ebook on this page?
                  </summary>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Ebook material is often chosen for a specific academic cycle, so session matching
                    helps students choose more relevant content.
                  </p>
                </details>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    ...
                    you want to browse all related ebooks inside one programme.
                  </p>
                </details>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Verify the title, subject code, course, session, and medium. These details help avoid opening the wrong ebook product.
                  </p>
                </details>
              </div>
            </div>
            ...
            <div className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {[
                  {
                    t: "Exam-ready digital content",
                    d: "Notes, guides, and study material organized for quicker discovery.",
                  },
                  {
                    t: "Fast ebook access",
                    d: "Quick browsing flow with smart filters and direct product-level discovery.",
                  },
                  {
