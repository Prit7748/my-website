...
type HandwrittenPdfsClientProps = {
...
const CATEGORY_LABEL = "Handwritten PDFs";
const PAGE_PATH = "/handwritten-pdfs";
const PAGE_URL = "https://istudentsportal.com/handwritten-pdfs";
...
function buildHandwrittenPdfsQueryKey(input: {
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="mt-1 text-[12px] font-semibold text-slate-600 md:text-[13px]">
                Find the right IGNOU handwritten PDF using subject code, course, session, and medium.
              </div>
            </div>
          </div>
...
export default function HandwrittenPdfsClient({
  initialSearchParam = "",
  initialCourseParam = "",
  initialSessionParam = "",
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const nextSessions = normalizeDropdownItems(
          uniq([...(facetSessionsRaw.length ? facetSessionsRaw : sessionApiItems)])
            .filter(Boolean)
  ...
  const queryKey = useMemo(() => {
    return buildHandwrittenPdfsQueryKey({
  ...
  const resultSummary = useMemo(() => {
    ...
    if (!parts.length) {
      return "Browse IGNOU handwritten PDFs across available courses, sessions, and mediums.";
    }
  ...
  const dynamicGuidanceParagraph = useMemo(() => {
    if (appliedSearch || selectedCourse.length || selectedSession.length || selectedLang.length) {
      return `Start with the exact subject code or title whenever possible, then confirm the course, session, and medium. This reduces mismatch risk and helps you reach the most relevant handwritten PDF without opening multiple similar products.`;
    }

    return `Students usually search handwritten study material in a practical order: subject code or title first, then course, then session, then medium. This page follows that same pattern so browsing stays faster and selection stays clearer.`;
  ...
  const faqJsonLd = useMemo(() => {
    const schema = {
      ...
      mainEntity: [
        {
          "@type": "Question",
          name: "How do I find the correct IGNOU handwritten PDF on this page?",
          acceptedAnswer: {
            "@type": "Answer",
        ...
        },
        {
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Handwritten study material is usually chosen for a specific academic or exam cycle, so session matching helps students choose more relevant material.",
          },
        },
        {
          "@type": "Question",
          name: "Can I search by course code instead of subject code?",
          acceptedAnswer: {
            "@type": "Answer",
            text: "Yes. Subject code is usually more precise, but course code filters are useful when you want to browse all related handwritten notes inside one programme.",
          },
        },
        {
          "@type": "Question",
          ...
          acceptedAnswer: {
            "@type": "Answer",
            text: "Verify the title, subject code, course, session, and medium. These details help avoid opening the wrong handwritten PDF product.",
          },
        },
      ],
    };
  ...
  const collectionJsonLd = useMemo(() => {
    const schema = {
      "@context": "https://schema.org",
      "@type": "CollectionPage",
      name: "IGNOU Handwritten PDFs",
      url: PAGE_URL,
      description:
        "Browse IGNOU handwritten PDFs by subject code, course, session, and medium.",
      isPartOf: {
        "@type": "WebSite",
            ...
            <div className="grid gap-6 px-5 py-6 md:px-7 md:py-7 lg:grid-cols-[minmax(0,1.3fr)_minmax(320px,0.7fr)] lg:items-start">
              <div className="max-w-4xl">
                <div className="inline-flex items-center rounded-full border border-white/15 bg-white/10 px-3 py-1 text-[11px] font-extrabold uppercase tracking-[0.2em] text-blue-100">
                  Handwritten notes • clearer study flow
                </div>

                <h1 className="mt-4 text-[28px] font-extrabold leading-tight text-white md:text-5xl">
                  IGNOU Handwritten PDFs for All Courses and Sessions
                </h1>

                <p className="mt-3 max-w-3xl text-sm font-medium leading-6 text-blue-50/90 md:text-base">
                  Search handwritten PDFs quickly using subject code, course, session, and medium.
                  The top section stays clean and student-focused so selection feels faster and easier.
                </p>
              ...
              <div className="grid gap-3">
                <div className="rounded-[26px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                  ...
                  <p className="mt-2 text-sm leading-6 text-blue-50/85">
                    Use codes like BEGC 101, BPSC 134, or your course code to reach the most
                    relevant handwritten notes faster.
                  </p>
                </div>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <div className="text-sm font-extrabold text-white">Readable notes</div>
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Better discovery flow for handwritten study material.
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-white/10 bg-white/10 p-4 backdrop-blur-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-[12px] font-semibold leading-5 text-blue-50/80">
                          Search first, filter next, then open the exact handwritten PDF.
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <h2 className="mt-1 text-xl font-extrabold text-slate-900 md:text-2xl">
                  Find the right IGNOU handwritten PDF faster
                </h2>
                ...
                <div className="mt-5 grid gap-3 md:grid-cols-3">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Codes like BEGC 101, BPSC 134, or MTE 01 usually return the cleanest
                      handwritten PDF result.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                      Sometimes the wrong session or medium filter blocks otherwise relevant
                      handwritten note matches.
                    </p>
                  </div>
          ...
          <section className="mt-10 space-y-6">
              ...
              <div className="grid gap-6 p-5 md:p-6 lg:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)] lg:items-start">
                <div>
                  ...
                  <h2 className="mt-4 text-2xl font-extrabold leading-tight text-slate-900 md:text-3xl">
                    How to find the correct IGNOU handwritten PDF without opening the wrong product
                  </h2>
                  ...
                  <p className="mt-3 text-sm font-medium leading-7 text-slate-700 md:text-[15px]">
                    The safest checking pattern is simple: search the subject code or handwritten note title first,
                    then confirm the course or programme, then match the session, and finally check the medium.
                    This works well on large handwritten-note catalogues where many titles can look similar.
                  </p>

                  <p className="mt-3 text-sm font-medium leading-7 text-slate-700 md:text-[15px]">
                    A strong category page should help students revise more confidently, not just scroll more.
                    That is why the top stays clean for quick discovery, while the lower section explains the
                    practical checks that matter before opening any handwritten PDF detail page.
                  </p>
                </div>
                  ...
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                          Exact subject codes usually narrow the list faster than broad browsing.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="rounded-[24px] border border-slate-200 bg-white p-4 shadow-sm">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="mt-2 text-[13px] font-medium leading-6 text-slate-600">
                          Similar-looking notes can belong to different study needs, so these checks matter.
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                <h3 className="text-xl font-extrabold text-slate-900">
                  How to choose the correct IGNOU handwritten PDF
                </h3>
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">
                      1. Search the subject code or title
                    </div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Exact codes and titles usually reach the correct handwritten note result faster than
                      broad keywords.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Course matching is important because similar subjects may appear in different programmes.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Session matching helps students choose material that fits the current academic or exam cycle.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Medium confirmation matters before opening the final handwritten PDF product page.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <article className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
                <h3 className="text-xl font-extrabold text-slate-900">
                  Why students prefer handwritten-style study material
                </h3>
                <div className="mt-4 space-y-4">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">
                      Closer to practical note-making
                    </div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Handwritten-style material often feels easier to relate to during personal study and revision.
                    </p>
                  </div>
                  ...
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    ...
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Many students revise faster when notes look more visual and compact than long blocks of plain text.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">
                      Better short revision flow
                    </div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Handwritten notes are often used for quick recap before assignments, exams, or last-minute review.
                    </p>
                  </div>

                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                    <div className="text-sm font-extrabold text-slate-900">
                      Filters help avoid mismatch
                    </div>
                    <p className="mt-1 text-[14px] font-medium leading-6 text-slate-600">
                      Narrowing by course, session, and medium saves time and keeps note selection cleaner.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <div className="mt-5 divide-y divide-slate-200">
                <details className="group py-4" open>
                  <summary className="cursor-pointer list-none pr-8 text-sm font-extrabold text-slate-900 marker:content-none">
                    How do I find the correct IGNOU handwritten PDF on this page?
                  </summary>
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Search the subject code or title first, then narrow the results using course,
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Handwritten study material is usually chosen for a specific academic or exam cycle,
                    so session matching helps students choose more relevant material.
                  </p>
                </details>

                <details className="group py-4">
                  <summary className="cursor-pointer list-none pr-8 text-sm font-extrabold text-slate-900 marker:content-none">
                    Can I search by course code instead of subject code?
                  </summary>
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Yes. Subject code is usually more precise, but course code filters are useful when
                    you want to browse all related handwritten notes inside one programme.
                  </p>
                </details>
                ...
                <details className="group py-4">
                  ...
                  <p className="mt-3 text-[14px] font-medium leading-7 text-slate-600">
                    Verify the title, subject code, course, session, and medium. These details help avoid
                    opening the wrong handwritten PDF product.
                  </p>
                </details>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="min-w-0">
                  ...
                  <div className="mt-1 text-sm font-semibold text-slate-600">
                    Explore all categories in one place, including solved assignments, question papers,
                    guess papers, ebooks, projects, combo packs, and more.
                  </div>
                </div>
            ...
            <div className="rounded-[30px] border border-slate-200 bg-white p-5 shadow-[0_12px_40px_rgba(15,23,42,0.05)] md:p-6">
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                {[
                  {
                    t: "Readable handwritten notes",
                    d: "Handwritten study material organized for quicker discovery and easier revision.",
                  },
                  {
                    t: "Fast digital access",
                    d: "Quick browsing flow with smart filters and direct product-level access.",
                  },
                  {
                    t: "Support when needed",
                    d: "Helpful assistance for matching, selection, and access-related questions.",
                  },
                ].map((x) => (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="text-lg font-extrabold text-slate-900">
                    Handwritten PDFs for better visual study support
                  </div>
                  <p className="mt-2 text-sm font-medium leading-7 text-slate-600">
                    Many students prefer handwritten-style study material because it feels closer to
                    practical note-making and can be easier to revise visually. This category page is
                    built to help students reach the correct handwritten PDFs faster without unnecessary browsing.
                  </p>
                </div>
              </div>
            </div>
