  ...
  return NextResponse.json(
    {
      ok: false,
      error:
        "Direct bulk image upload route disabled hai. Ab sirf job-based batch system allowed hai.",
      routeDisabled: true,
      useRoute: "/api/products/bulk-images/jobs",
      processRoute: "/api/products/bulk-images/jobs/process",
      message:
        "Old single-request ZIP upload intentionally blocked to prevent timeout, freeze, and partial unsafe processing.",
      ...(extra || {}),
    },
    { status: 410 }
  );
