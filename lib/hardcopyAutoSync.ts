...
function normalizeLanguageLabel(inputLanguage: any, inputLang3?: any) {
  ...
  if (langLower === "hindi" || lang3 === "HIN") return "Hindi";
  if (langLower === "english" || lang3 === "ENG") return "English";
  if (langLower === "sanskrit" || lang3 === "SAN") return "Sanskrit";
...
function isAllowedHardcopyLanguage(inputLanguage: any, inputLang3?: any) {
  ...
  const lang3 = normalizeLang3(inputLang3 || inputLanguage);
  return label === "hindi" || label === "english" || label === "sanskrit" || ["HIN", "ENG", "SAN"].includes(lang3);
}
